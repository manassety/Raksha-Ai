...
const AdminPanel = () => {
    ...
    useEffect(() => {
        ...
        if (!loading && userData && !userData.isAdmin && !userData.isMainAdmin) {
            Alert.alert('Access Denied', 'Your admin privileges have been removed.');
    ...
    const UserCard = ({ user }) => (
        <View style={styles.userCard}>
            ...
            <View style={styles.userActions}>
                ...
                {userData?.isMainAdmin && !user.isMainAdmin && (
                    <TouchableOpacity
                        style={styles.actionBtn}
                ...
                {userData?.isMainAdmin && (user.isMainAdmin || user.isAdmin) && (user.id !== userData.uid) && (
                    <TouchableOpacity
                        style={styles.actionBtn}
                                ...
                                <View style={styles.overviewContent}>
                                    ...
                                    <View style={styles.quickActions}>
                                        ...
                                        >
                                            ...
                                            <Text style={styles.quickActionText}>Live SOS Monitor</Text>
                                        </TouchableOpacity>
                                    </View>
                                </View>
                            )}
