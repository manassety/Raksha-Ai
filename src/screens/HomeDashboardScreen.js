...
const HomeDashboardScreen = () => {
  ...
  useEffect(() => {
    ...
    // Request critical permissions silently on initial load
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          <View>
            ...
            <Text style={styles.userName}>{userData?.name || user?.email?.split('@')[0] || 'RakshaAi User'}</Text>
          </View>
          <TouchableOpacity
        ...
        >
          ...
          <View style={styles.sosContainer}>
            ...
            <Text style={styles.sosHint}>Tap instantly to activate SOS</Text>
          </View>
