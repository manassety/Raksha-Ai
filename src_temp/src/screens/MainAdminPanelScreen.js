...
const MainAdminPanelScreen = () => {
    ...
    const checkMainAdminAccess = async () => {
        try {
            const auth = getAuth();
            ...
            if (currentUser) {
                ...
                if (userDoc.exists()) {
                    ...
                    if (!data.isMainAdmin) {
                        Alert.alert('Access Denied', 'Only the Main Admin can access this panel.');
            ...
            console.log("Error checking main admin access:", error);
        }
    };
